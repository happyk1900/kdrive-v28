    ...
    if (!document.getElementById(styleId)) {
        ...
        style.textContent = `
            ...
            .chat-header {
                ...
                border-bottom: 1px solid rgba(0, 229, 255, 0.3); padding-bottom: 10px; margin-bottom: 15px;
            }
            .chat-title {
                color: #00e5ff; font-family: 'Montserrat', sans-serif; font-size: 15px; font-weight: 900;
                text-transform: uppercase; text-shadow: 0 0 10px rgba(0, 229, 255, 0.8);
            }
            .chat-close-btn {
                color: #ff3366; background: transparent; border: none; font-size: 20px; font-weight: bold;
                cursor: pointer; text-shadow: 0 0 8px rgba(255,51,102,0.8); padding: 0 5px;
            }
            ...
            .chat-send-btn {
                ...
                border-radius: 8px; padding: 0 20px; font-family: 'Montserrat', sans-serif; font-weight: 900;
                cursor: pointer; transition: 0.3s; text-transform: uppercase;
            }
            .chat-send-btn:hover { background: rgba(255, 51, 102, 0.3); color: #fff; box-shadow: 0 0 15px rgba(255,51,102,0.6); }
        `;
